...
outliercutAPM2MHCI <- outliercutAPM2MHCI[MHCI_Reggenes,]
library(psych)
cor_test_mat <- corr.test(t(outliercutAPM2MHCI))$p    # Apply corr.test function
cor_test_mat                         # Print matrix of p-values
cor_mat <- cor(t(outliercutAPM2MHCI))              # Correlation matrix of example data
cor_mat     
library("corrplot") 
corrplot(cor_mat,                    # Draw corrplot with p-values
         p.mat = cor_test_mat,
...
p1 + ggtitle("Correlation of MHC I genes and APM regulators n = 176")+ theme(text = element_text(size = 15)) 

MHCII_Reggenes <- c(  "HLA-DMA",
                      "HLA-DMB",
                      "HLA-DOA",
                      "HLA-DPA1",
                      "HLA-DPB1",
...
outliercutAPM2MHCII <- outliercutAPM[MHCII_Reggenes,]

library(psych)
cor_test_mat <- corr.test(t(outliercutAPM2MHCII))$p    # Apply corr.test function
cor_test_mat                         # Print matrix of p-values
cor_mat <- cor(t(outliercutAPM2MHCII))              # Correlation matrix of example data
cor_mat     
library("corrplot") 
corrplot(cor_mat,                    # Draw corrplot with p-values
         p.mat = cor_test_mat,
